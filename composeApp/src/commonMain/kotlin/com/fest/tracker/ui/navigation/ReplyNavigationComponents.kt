...
package com.fest.tracker.ui.navigation
...
import com.fest.tracker.ui.utils.ReplyNavigationContentPosition
import festtracker.composeapp.generated.resources.Res
import festtracker.composeapp.generated.resources.*
        ...
        Column(
            ...
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.compose),
        ...
        TOP_LEVEL_DESTINATIONS.forEach { replyDestination ->
            NavigationBarItem(
                ...
                icon = {
                    Icon(
                        imageVector = replyDestination.selectedIcon,
                        contentDescription = stringResource(replyDestination.iconText)
                    )
                }
            )
        }
            ...
            content = {
                Column(
                    ...
                    ExtendedFloatingActionButton(
                        ...
                        Text(
                            text = stringResource(Res.string.compose),
                ...
                Column(
                    ...
                    TOP_LEVEL_DESTINATIONS.forEach { replyDestination ->
                        NavigationDrawerItem(
                            ...
                            label = {
                                Text(
                                    text = stringResource(replyDestination.iconText),
